...
(
  ...
  for u in cat ls echo true false ed grep wc sort find cmp tr dmesg ps top head whoami write rm mkdir mv chmod chown test expr usbrw fsd gpio wasm stdiotest; do
